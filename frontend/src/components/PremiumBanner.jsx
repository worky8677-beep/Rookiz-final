export function PremiumBanner() {
  return (
    <div className="mx-4 md:mx-10 min-h-30 md:h-40 bg-blue-900 rounded-2xl md:rounded-4xl flex flex-col md:flex-row items-start md:items-center justify-between p-6 md:px-8 relative overflow-hidden shadow-lg gap-4">
