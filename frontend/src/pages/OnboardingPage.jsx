...
function StepIntro({ form, onChange, onNext }) {
  ...
  return (
    <div className="flex flex-col items-center w-full max-w-onboard-sm px-4 gap-5 pb-12 md:pb-25">
      <LoginCharacter />
...
function AgeCard({ card, selected, onSelect }) {
  return (
    <button
      ...
      className={twMerge(
        "bg-white border-2 rounded-3xl shadow-card p-6 pb-2 w-full sm:w-age-card flex flex-col items-start gap-4 cursor-pointer transition-colors",
  ...
  return (
    <div className="flex flex-col items-center w-full max-w-onboard-md px-4 gap-6 pb-12 md:pb-25">
      ...
      <div className="text-center">
        <h2 className="text-xl md:text-2xl font-extrabold text-blue-950 leading-6">
          아이의 연령대 카드를 선택해주세요
        </h2>
